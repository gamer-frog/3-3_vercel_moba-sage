...
export const SKIN_NAMES: Record<string, Record<number, string>> = {
  ...
  // --- Slot 08 Tick #182 additions (16 missing champions) ---
  "Bel'Veth":     { 0: 'Clásica', 1: 'Empyrean', 2: 'Haunting', 3: 'Prestige Empyrean' },
  'Cassiopeia':   { 0: 'Clásica', 1: 'Desperada', 2: 'Mythic', 3: 'Siren', 4: 'Jade Fang', 5: 'Battlecast', 6: 'Spirit Blossom', 7: 'Arcade' },
  'Evelynn':      { 0: 'Clásica', 1: 'Shadow', 2: 'Tango', 3: 'Masquerade', 4: 'Safecracker', 5: 'Blood Moon', 6: 'K/DA', 7: 'K/DA ALL OUT', 8: 'Prestige K/DA', 9: 'SG', 10: 'Eden', 11: 'Arcane' },
  'Hwei':         { 0: 'Clásica', 1: 'Dreaming', 2: 'Masquerade' },
  "K'Sante":      { 0: 'Clásica', 1: 'Prestige', 2: 'NOTFT', 3: 'Dawnbringer' },
  'Kayle':        { 0: 'Clásica', 1: 'Viridian', 2: 'Silver', 3: 'Judgment', 4: 'Battleborn', 5: 'Unmasked', 6: 'Aether Wing', 7: 'Pentakill', 8: 'Transcended', 9: 'Star Guardian', 10: 'PROJECT:' },
  'Naafiri':      { 0: 'Clásica', 1: 'Darkin', 2: 'Cafe Cuties', 3: 'Elderwood' },
  'Olaf':         { 0: 'Clásica', 1: 'Forsaken', 2: 'Glacial', 3: 'Brolaf', 4: 'Marauder', 5: 'Blood Moon', 6: 'Count Olaf', 7: 'Thunder Lord', 8: 'Battlecast', 9: 'Soul Fighter', 10: 'Arcade' },
  'Rammus':       { 0: 'Clásica', 1: 'Chrome', 2: 'Freljord', 3: 'NASA', 4: 'Blut', 5: 'Desperado', 6: 'Guardian of the Sands', 7: 'Dark Star', 8: 'Emerald', 9: 'Porcelain' },
  "Rek'Sai":      { 0: 'Clásica', 1: 'Oceanic', 2: 'Pool Party', 3: 'Guardian of the Sands', 4: 'Sweetheart', 5: 'Empyrean' },
  'Seraphine':    { 0: 'Clásica', 1: 'K/DA', 2: 'K/DA ALL OUT', 3: 'PsyOps', 4: 'Star Guardian', 5: 'True Damage', 6: 'Debonair' },
  'Smolder':      { 0: 'Clásica', 1: 'Ashen Knight', 2: 'Cafe Cuties', 3: 'Crystal Rose' },
  'Sona':         { 0: 'Clásica', 1: 'Muse', 2: 'Silent Night', 3: 'Pentakill', 4: 'Guqin', 5: 'Arcade', 6: 'DJ', 7: 'PsyOps', 8: 'Star Guardian', 9: 'Spirit Blossom' },
  'Taric':        { 0: 'Clásica', 1: 'Emerald', 2: 'Armor of the Fifth Age', 3: 'Bloodstone', 4: 'Pool Party', 5: 'Eternals', 6: 'Battlecast', 7: 'Debonair' },
  "Vel'Koz":      { 0: 'Clásica', 1: 'Battlecast', 2: 'Arclight', 3: 'SKT T1', 4: 'PsyOps', 5: 'Emerald', 6: 'Infernal' },
  'Vladimir':     { 0: 'Clásica', 1: 'Count', 2: 'Marquis', 3: 'Blood Lord', 4: 'Soulstealer', 5: 'Dark Waters', 6: 'Vandal', 7: 'Academy', 8: 'Nightbringer', 9: 'Arclight', 10: 'Porcelain', 11: 'Battlecast' },
