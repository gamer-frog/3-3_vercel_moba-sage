...
const CHAMPIONS_DATA: Omit<Champion, 'id' | 'createdAt' | 'updatedAt'>[] = [
  ...
  { name: 'Rakan', title: 'el Encantador', role: 'Support', tier: 'B', winRate: 48.1, pickRate: 2.1, banRate: 0.2, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '26.9', game: 'LoL',
    ...
    aiAnalysis: "Rakan baja a B-tier. Build de Redención → Convergencia de Zeke. Consejo: Coordinación con tu ADC es clave para engages exitosos.",
    proPickRate: 2.8,
    runes: {"primary":"Valor — Guardián","secondary":"Brujería — Debilidad","shards":"Armadura + Fuerza + Resistencia"},
  },
  { name: 'Xin Zhao', title: 'el Senescal de Demacia', role: 'Jungle', tier: 'B', winRate: 48.7, pickRate: 2.8, banRate: 0.4, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '26.9', game: 'LoL',
    ...
    aiAnalysis: "Xin Zhao baja a B-tier. Build de Eclipse → Sed de Sangre. Consejo: Prioriza ganks tempranos antes de que el juego se escape.",
    proPickRate: 1.8,
  ...
  { name: 'Tristana', title: 'la Pistolera Yordle', role: 'ADC', tier: 'B', winRate: 48.9, pickRate: 4.3, banRate: 0.5, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '26.9', game: 'LoL',
    ...
    aiAnalysis: "Tristana baja a B-tier. Build de Filo Infinito → Huracán de Runaan. Consejo: Abusa de tu E para push y roam temprano.",
    proPickRate: 2.2,
    runes: {"primary":"Precisión — Pies Veloces","secondary":"Dominación — Colección de Ojos","shards":"Adaptativo + Fuerza + Resistencia"},
  },
  ...
  { name: 'Nidalee', title: 'la Cazadora Bestial', role: 'Jungle', tier: 'B', winRate: 46.5, pickRate: 2.0, banRate: 0.4, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '26.9', game: 'LoL',
    ...
    aiAnalysis: "Nidalee cae a B-tier con 46.5% WR, la más baja entre junglers. Build de Llamarada Sombría. Consejo: Tus spears en early son clave para el control del mapa.",
    proPickRate: 2,
    runes: {"primary":"Brujería — Cometa Arcano","secondary":"Dominación — Colección de Ojos","shards":"Adaptativo + Fuerza + Resistencia"},
  },
  { name: 'Braum', title: 'el Corazón de los Freljord', role: 'Support', tier: 'B', winRate: 46.8, pickRate: 1.8, banRate: 0.1, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '26.9', game: 'LoL',
    ...
    aiAnalysis: "Braum baja a B-tier. Build de Medallón de los Solari → Redención. Consejo: Tu E es el mejor peel del juego — úsalo en teamfights.",
    proPickRate: 1.5,
    runes: {"primary":"Valor — Guardián","secondary":"Brujería — Debilidad","shards":"Armadura + Fuerza + Resistencia"},
  },
  ...
  { name: 'Yorick', title: 'el Pastor de Almas', role: 'Top', tier: 'C', winRate: 46.2, pickRate: 1.4, banRate: 0.3, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '26.9', game: 'LoL',
    ...
    aiAnalysis: "Yorick cae a C-tier. El meta actual no favorece su split push lento. Build de Fuerza de la Trinidad → Hidra Titánica. Consejo: Tu mejor opción es evitar confrontaciones tempranas y farmear.",
    proPickRate: 0.5,
    runes: {"primary":"Precisión — Conquistador","secondary":"Valor — Segunda Vida","shards":"Adaptativo + Velocidad + Resistencia"},
  },
  { name: 'Ivern', title: 'el Padre Verde', role: 'Jungle', tier: 'C', winRate: 45.8, pickRate: 0.9, banRate: 0.1, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '26.9', game: 'LoL',
    ...
    aiAnalysis: "Ivern cae a C-tier con el meta de bruiser junglers. Build de Redención. Consejo: Daisy peeling para tu carry es tu mayor contribución.",
    proPickRate: 0.3,
  ...
  { name: 'Kalista', title: 'la Lanza de la Venganza', role: 'ADC', tier: 'C', winRate: 45.5, pickRate: 1.2, banRate: 0.2, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '26.9', game: 'LoL',
    ...
    aiAnalysis: "Kalista cae a C-tier. Su dependencia de un support coordinado la hace frágil en soloQ. Build de Bailarín Espectral → Filo Infinito. Consejo: Solo pick con un support premade.",
    proPickRate: 0.8,
    runes: {"primary":"Precisión — Pies Veloces","secondary":"Dominación — Sabor a Sangre","shards":"Adaptativo + Fuerza + Resistencia"},
  },
  ...
  { name: 'Bard', title: 'el Cuidador Errante', role: 'Support', tier: 'C', winRate: 43.5, pickRate: 1.3, banRate: 0.1, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '26.9', game: 'LoL',
    ...
    aiAnalysis: "Bard cae a C-tier. Su inconsistencia en soloQ lo hace riesgoso. Build de Redención → Mikael. Consejo: Tus chimes son importantes pero no los priorices sobre tu ADC.",
    proPickRate: 1.5,
    runes: {"primary":"Valor — Guardián","secondary":"Brujería — Debilidad","shards":"Armadura + Velocidad + Resistencia"},
  },
  { name: 'Skarner', title: 'el Vanguardia de Cristal', role: 'Jungle', tier: 'C', winRate: 44.1, pickRate: 0.8, banRate: 0.1, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '26.9', game: 'LoL',
    ...
    aiAnalysis: "Skarner cae a C-tier. Build de Jak'Sho → Resistencia Divina. Consejo: Controla las zonas de objetivos con tu pasiva.",
    proPickRate: 0.2,
  ...
  { name: 'Urgot', title: 'el Acorazado', role: 'Top', tier: 'C', winRate: 44.5, pickRate: 1.6, banRate: 0.3, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '26.9', game: 'LoL',
    ...
    counterPick: 'Teemo, Vayne, Quinn',
    synergy: 'Orianna, Wukong, Malphite',
    aiAnalysis: "Urgot cae a C-tier. Build de Fuerza de la Trinidad → Sed de Sangre. Consejo: Tu R es game-changing en teamfights — apuntá al carry enemigo.",
    proPickRate: 0.6,
    runes: {"primary":"Precisión — Conquistador","secondary":"Valor — Segunda Vida","shards":"Adaptativo + Velocidad + Resistencia"},
  },
