...
const CHAMPIONS_DATA: Omit<Champion, 'id' | 'createdAt' | 'updatedAt'>[] = [
  ...
  {
    name: 'Lee Sin', title: 'el Monje Ciego', passiveAbility: { name: 'Flurry', description: "After Lee Sin uses an ability, his next 2 basic attacks gain Attack Speed and return Energy." }, role: 'Jungle', tier: 'B', winRate: 53.5, pickRate: 7.0, banRate: 4.2, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '26.9', game: 'LoL',
  ...
  },
  {
    ...
    aiAnalysis: "Darius cae a B-tier con 49.8% WR. El meta de kiting y ranged tops le dificulta la lane phase. Build de Fuerza de la Trinidad → Sed de Sangre. Consejo: Busca timings de ghost para ganks de lado.",
    proPickRate: 10.3,
    runes: { primary: 'Precisión — Conquistador', secondary: 'Valor — Segunda Vida', shards: 'Adaptativo + Velocidad + Resistencia' },
  },
  {
  ...
  { name: 'Katarina', title: 'la Hoja Siniestra', passiveAbility: { name: 'Voracity', description: "Whenever an enemy champion dies that Katarina has damaged recently, her remaining ability cooldowns are dramatically reduced.If Katarina picks up a Dagger, she uses it to slash through all nearby e..." }, role: 'Mid', tier: 'A', winRate: 50.6, pickRate: 5.8, banRate: 3.1, image: '', aiInsight: '', build: '', counters: '', synergies: '', patch: '26.9', game: 'LoL',
    ...
    aiAnalysis: "Katarina baja a A-tier pero sigue siendo una mid laner letal. Con 53% WR, su capacidad de snowball en teamfights es innegable. El ajuste en sus ratios redujo su burst pero mantiene su escala. Build de Llamarada Sombría → Sombrero de Rabadón → Reloj de Zhonya. Consejo: Espera a que el enemigo gaste CC antes de entrar con tu R.",
    proPickRate: 3.5,
